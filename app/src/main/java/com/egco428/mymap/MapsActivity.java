...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void setUpMap() {
        ...
        Polyline line = mMap.addPolyline(new PolylineOptions()
                .add(new LatLng(15.55234, 100), new LatLng(15.4231,100.45612), new LatLng(15, 100.45612),new LatLng(13.7934, 100.3225), new LatLng(15.1123, 100.05612), new LatLng(15.55234, 100))
                .width(5)
                .color(Color.RED));
    }
